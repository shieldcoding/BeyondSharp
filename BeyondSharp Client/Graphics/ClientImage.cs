// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ClientImage.cs" company="ShieldCoding">
...
namespace BeyondSharp.Client.Graphics
{
    ...
    public class ClientImage : Image<ClientImage>
    {
        ...
        /// </summary>
        /// <param name="image">
        /// The image to be blended into the source image.
        /// </param>
        /// <param name="method">
        /// The method by which to blend the two images.
        /// </param>
        /// <returns>
        /// The client image with the image operation applied.
        /// </returns>
        ...
        /// </summary>
        /// <param name="color">
        /// The color to be blended into the source image.
        /// </param>
        /// <param name="method">
        /// The method by which to blend the two images.
        /// </param>
